...
/*!   \fn xbrtime_TYPENAME_reduct_FUNC( TYPE *dest, const TYPE *src, size_t nelems, int stride, int root )
      ...
      \param dest is a pointer to the base shared address where final reduct values are placed on the root PE
      ...
      \param nelems is the number of elements on each PE on which reduct op FUNC is to be performed
      \param stride is the stride size between reduct elements at src and dest
      \param root is the PE id of the root PE
      \return void
*/
#define XBGAS_DECL_REDUCT(_type, _typename, _funcname)                                                            \
void xbrtime_##_typename##_reduct_##_funcname(_type *dest, const _type *src, size_t nelems, int stride, int root);

    /* Sum */
    XBGAS_DECL_REDUCT(float, float, sum)
    XBGAS_DECL_REDUCT(double, double, sum)
    XBGAS_DECL_REDUCT(char, char, sum)
    XBGAS_DECL_REDUCT(unsigned char, uchar, sum)
    XBGAS_DECL_REDUCT(signed char, schar, sum)
    XBGAS_DECL_REDUCT(unsigned short, ushort, sum)
    XBGAS_DECL_REDUCT(short, short, sum)
    XBGAS_DECL_REDUCT(unsigned int, uint, sum)
    XBGAS_DECL_REDUCT(int, int, sum)
    XBGAS_DECL_REDUCT(unsigned long, ulong, sum)
    XBGAS_DECL_REDUCT(long, long, sum)
    XBGAS_DECL_REDUCT(unsigned long long, ulonglong, sum)
    XBGAS_DECL_REDUCT(long long, longlong, sum)
    XBGAS_DECL_REDUCT(uint8_t, uint8, sum)
    XBGAS_DECL_REDUCT(int8_t, int8, sum)
    XBGAS_DECL_REDUCT(uint16_t, uint16, sum)
    XBGAS_DECL_REDUCT(int16_t, int16, sum)
    XBGAS_DECL_REDUCT(uint32_t, uint32, sum)
    XBGAS_DECL_REDUCT(int32_t, int32, sum)
    XBGAS_DECL_REDUCT(uint64_t, uint64, sum)
    XBGAS_DECL_REDUCT(int64_t, int64, sum)
    XBGAS_DECL_REDUCT(size_t, size, sum)
    XBGAS_DECL_REDUCT(ptrdiff_t, ptrdiff, sum)
    //  XBGAS_DECL_REDUCT(long double, longdouble, sum)

    /* Product */
    XBGAS_DECL_REDUCT(float, float, product)
    XBGAS_DECL_REDUCT(double, double, product)
    XBGAS_DECL_REDUCT(char, char, product)
    XBGAS_DECL_REDUCT(unsigned char, uchar, product)
    XBGAS_DECL_REDUCT(signed char, schar, product)
    XBGAS_DECL_REDUCT(unsigned short, ushort, product)
    XBGAS_DECL_REDUCT(short, short, product)
    XBGAS_DECL_REDUCT(unsigned int, uint, product)
    XBGAS_DECL_REDUCT(int, int, product)
    XBGAS_DECL_REDUCT(unsigned long, ulong, product)
    XBGAS_DECL_REDUCT(long, long, product)
    XBGAS_DECL_REDUCT(unsigned long long, ulonglong, product)
    XBGAS_DECL_REDUCT(long long, longlong, product)
    XBGAS_DECL_REDUCT(uint8_t, uint8, product)
    XBGAS_DECL_REDUCT(int8_t, int8, product)
    XBGAS_DECL_REDUCT(uint16_t, uint16, product)
    XBGAS_DECL_REDUCT(int16_t, int16, product)
    XBGAS_DECL_REDUCT(uint32_t, uint32, product)
    XBGAS_DECL_REDUCT(int32_t, int32, product)
    XBGAS_DECL_REDUCT(uint64_t, uint64, product)
    XBGAS_DECL_REDUCT(int64_t, int64, product)
    XBGAS_DECL_REDUCT(size_t, size, product)
    XBGAS_DECL_REDUCT(ptrdiff_t, ptrdiff, product)
    //  XBGAS_DECL_REDUCT(long double, longdouble, product)

    /* Binary AND */
    XBGAS_DECL_REDUCT(char, char, and)
    XBGAS_DECL_REDUCT(unsigned char, uchar, and)
    XBGAS_DECL_REDUCT(signed char, schar, and)
    XBGAS_DECL_REDUCT(unsigned short, ushort, and)
    XBGAS_DECL_REDUCT(short, short, and)
    XBGAS_DECL_REDUCT(unsigned int, uint, and)
    XBGAS_DECL_REDUCT(int, int, and)
    XBGAS_DECL_REDUCT(unsigned long, ulong, and)
    XBGAS_DECL_REDUCT(long, long, and)
    XBGAS_DECL_REDUCT(unsigned long long, ulonglong, and)
    XBGAS_DECL_REDUCT(long long, longlong, and)
    XBGAS_DECL_REDUCT(uint8_t, uint8, and)
    XBGAS_DECL_REDUCT(int8_t, int8, and)
    XBGAS_DECL_REDUCT(uint16_t, uint16, and)
    XBGAS_DECL_REDUCT(int16_t, int16, and)
    XBGAS_DECL_REDUCT(uint32_t, uint32, and)
    XBGAS_DECL_REDUCT(int32_t, int32, and)
    XBGAS_DECL_REDUCT(uint64_t, uint64, and)
    XBGAS_DECL_REDUCT(int64_t, int64, and)
    XBGAS_DECL_REDUCT(size_t, size, and)
    XBGAS_DECL_REDUCT(ptrdiff_t, ptrdiff, and)

    /* Binary OR */
    XBGAS_DECL_REDUCT(char, char, or)
    XBGAS_DECL_REDUCT(unsigned char, uchar, or)
    XBGAS_DECL_REDUCT(signed char, schar, or)
    XBGAS_DECL_REDUCT(unsigned short, ushort, or)
    XBGAS_DECL_REDUCT(short, short, or)
    XBGAS_DECL_REDUCT(unsigned int, uint, or)
    XBGAS_DECL_REDUCT(int, int, or)
    XBGAS_DECL_REDUCT(unsigned long, ulong, or)
    XBGAS_DECL_REDUCT(long, long, or)
    XBGAS_DECL_REDUCT(unsigned long long, ulonglong, or)
    XBGAS_DECL_REDUCT(long long, longlong, or)
    XBGAS_DECL_REDUCT(uint8_t, uint8, or)
    XBGAS_DECL_REDUCT(int8_t, int8, or)
    XBGAS_DECL_REDUCT(uint16_t, uint16, or)
    XBGAS_DECL_REDUCT(int16_t, int16, or)
    XBGAS_DECL_REDUCT(uint32_t, uint32, or)
    XBGAS_DECL_REDUCT(int32_t, int32, or)
    XBGAS_DECL_REDUCT(uint64_t, uint64, or)
    XBGAS_DECL_REDUCT(int64_t, int64, or)
    XBGAS_DECL_REDUCT(size_t, size, or)
    XBGAS_DECL_REDUCT(ptrdiff_t, ptrdiff, or)

    /* Binary XOR */
    XBGAS_DECL_REDUCT(char, char, xor)
    XBGAS_DECL_REDUCT(unsigned char, uchar, xor)
    XBGAS_DECL_REDUCT(signed char, schar, xor)
    XBGAS_DECL_REDUCT(unsigned short, ushort, xor)
    XBGAS_DECL_REDUCT(short, short, xor)
    XBGAS_DECL_REDUCT(unsigned int, uint, xor)
    XBGAS_DECL_REDUCT(int, int, xor)
    XBGAS_DECL_REDUCT(unsigned long, ulong, xor)
    XBGAS_DECL_REDUCT(long, long, xor)
    XBGAS_DECL_REDUCT(unsigned long long, ulonglong, xor)
    XBGAS_DECL_REDUCT(long long, longlong, xor)
    XBGAS_DECL_REDUCT(uint8_t, uint8, xor)
    XBGAS_DECL_REDUCT(int8_t, int8, xor)
    XBGAS_DECL_REDUCT(uint16_t, uint16, xor)
    XBGAS_DECL_REDUCT(int16_t, int16, xor)
    XBGAS_DECL_REDUCT(uint32_t, uint32, xor)
    XBGAS_DECL_REDUCT(int32_t, int32, xor)
    XBGAS_DECL_REDUCT(uint64_t, uint64, xor)
    XBGAS_DECL_REDUCT(int64_t, int64, xor)
    XBGAS_DECL_REDUCT(size_t, size, xor)
    XBGAS_DECL_REDUCT(ptrdiff_t, ptrdiff, xor)

    /* Max */
    XBGAS_DECL_REDUCT(float, float, max)
    XBGAS_DECL_REDUCT(double, double, max)
    XBGAS_DECL_REDUCT(char, char, max)
    XBGAS_DECL_REDUCT(unsigned char, uchar, max)
    XBGAS_DECL_REDUCT(signed char, schar, max)
    XBGAS_DECL_REDUCT(unsigned short, ushort, max)
    XBGAS_DECL_REDUCT(short, short, max)
    XBGAS_DECL_REDUCT(unsigned int, uint, max)
    XBGAS_DECL_REDUCT(int, int, max)
    XBGAS_DECL_REDUCT(unsigned long, ulong, max)
    XBGAS_DECL_REDUCT(long, long, max)
    XBGAS_DECL_REDUCT(unsigned long long, ulonglong, max)
    XBGAS_DECL_REDUCT(long long, longlong, max)
    XBGAS_DECL_REDUCT(uint8_t, uint8, max)
    XBGAS_DECL_REDUCT(int8_t, int8, max)
    XBGAS_DECL_REDUCT(uint16_t, uint16, max)
    XBGAS_DECL_REDUCT(int16_t, int16, max)
    XBGAS_DECL_REDUCT(uint32_t, uint32, max)
    XBGAS_DECL_REDUCT(int32_t, int32, max)
    XBGAS_DECL_REDUCT(uint64_t, uint64, max)
    XBGAS_DECL_REDUCT(int64_t, int64, max)
    XBGAS_DECL_REDUCT(size_t, size, max)
    XBGAS_DECL_REDUCT(ptrdiff_t, ptrdiff, max)
    //  XBGAS_DECL_REDUCT(long double, longdouble, max)

    /* Min */
    XBGAS_DECL_REDUCT(float, float, min)
    XBGAS_DECL_REDUCT(double, double, min)
    XBGAS_DECL_REDUCT(char, char, min)
    XBGAS_DECL_REDUCT(unsigned char, uchar, min)
    XBGAS_DECL_REDUCT(signed char, schar, min)
    XBGAS_DECL_REDUCT(unsigned short, ushort, min)
    XBGAS_DECL_REDUCT(short, short, min)
    XBGAS_DECL_REDUCT(unsigned int, uint, min)
    XBGAS_DECL_REDUCT(int, int, min)
    XBGAS_DECL_REDUCT(unsigned long, ulong, min)
    XBGAS_DECL_REDUCT(long, long, min)
    XBGAS_DECL_REDUCT(unsigned long long, ulonglong, min)
    XBGAS_DECL_REDUCT(long long, longlong, min)
    XBGAS_DECL_REDUCT(uint8_t, uint8, min)
    XBGAS_DECL_REDUCT(int8_t, int8, min)
    XBGAS_DECL_REDUCT(uint16_t, uint16, min)
    XBGAS_DECL_REDUCT(int16_t, int16, min)
    XBGAS_DECL_REDUCT(uint32_t, uint32, min)
    XBGAS_DECL_REDUCT(int32_t, int32, min)
    XBGAS_DECL_REDUCT(uint64_t, uint64, min)
    XBGAS_DECL_REDUCT(int64_t, int64, min)
    XBGAS_DECL_REDUCT(size_t, size, min)
    XBGAS_DECL_REDUCT(ptrdiff_t, ptrdiff, min)
    //  XBGAS_DECL_REDUCT(long double, longdouble, min)

#undef XBGAS_DECL_REDUCT
