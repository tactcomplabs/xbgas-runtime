...
uint32_t __xbrtime_atomic_compare_swap_u4(uint64_t base_dest, uint32_t comp_val, uint32_t pe);
int32_t __xbrtime_atomic_compare_swap_s4(uint64_t base_dest, int32_t comp_val, uint32_t pe);
uint64_t __xbrtime_atomic_compare_swap_u8(uint64_t base_dest, uint64_t comp_val, uint32_t pe);
int64_t __xbrtime_atomic_compare_swap_s8(uint64_t base_dest, int64_t comp_val, uint32_t pe);
