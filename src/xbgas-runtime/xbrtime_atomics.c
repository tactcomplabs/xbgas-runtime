...
{                                                                                                                           \
    __xbrtime_atomic_##_op##_##_typesize(__xbrtime_ltor(((_XBRTIME_XLEN_)dest), pe), (_typecast) op_val, xbrtime_decode_pe(pe));  \
}
...
{                                                                                                                           \
    __xbrtime_atomic_compare_swap_##_typesize(__xbrtime_ltor(((_XBRTIME_XLEN_)dest), pe),                                         \
