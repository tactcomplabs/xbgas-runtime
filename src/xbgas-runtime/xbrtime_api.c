...
void xbgas_double_get(double *dest, const double *src,
  ...
  if( nelems >= _XBRTIME_MIN_UNR_THRESHOLD_ ){
    ...
    /* sequential execution */
    __xbrtime_get_u8_seq((uint64_t)(src),
                         (uint64_t)(dest),
                         xbrtime_decode_pe(pe),
                         (uint32_t)(nelems),
                         (uint32_t)(stride*sizeof(double)));
...
void xbgas_schar_get(signed char *dest, const signed char *src,
  ...
  if( nelems >= _XBRTIME_MIN_UNR_THRESHOLD_ ){
    ...
    /* sequential execution */
    __xbrtime_get_s1_seq((uint64_t)(src),
                         (uint64_t)(dest),
                         xbrtime_decode_pe(pe),
                         (uint32_t)(nelems),
                         (uint32_t)(stride*sizeof(signed char)));
...
void xbgas_char_get(char *dest, const char *src,
  ...
  if( nelems >= _XBRTIME_MIN_UNR_THRESHOLD_ ){
    ...
    /* sequential execution */
    __xbrtime_get_u1_seq((uint64_t)(src),
                         (uint64_t)(dest),
                         xbrtime_decode_pe(pe),
                         (uint32_t)(nelems),
                         (uint32_t)(stride*sizeof(char)));
...
void xbgas_short_get(short *dest, const short *src,
  ...
  if( nelems >= _XBRTIME_MIN_UNR_THRESHOLD_ ){
    ...
    /* sequential execution */
    __xbrtime_get_s2_seq((uint64_t)(src),
                         (uint64_t)(dest),
                         xbrtime_decode_pe(pe),
                         (uint32_t)(nelems),
                         (uint32_t)(stride*sizeof(short)));
...
void xbgas_int_get(int *dest, const int *src,
  ...
  if( nelems >= _XBRTIME_MIN_UNR_THRESHOLD_ ){
    ...
    /* sequential execution */
    __xbrtime_get_s4_seq((uint64_t)(src),
                         (uint64_t)(dest),
                         xbrtime_decode_pe(pe),
                         (uint32_t)(nelems),
                         (uint32_t)(stride*sizeof(int)));
...
void xbgas_longlong_get(long long *dest, const long long *src,
  ...
  if( nelems >= _XBRTIME_MIN_UNR_THRESHOLD_ ){
    ...
    /* sequential execution */
    __xbrtime_get_s8_seq((uint64_t)(src),
                         (uint64_t)(dest),
                         xbrtime_decode_pe(pe),
                         (uint32_t)(nelems),
                         (uint32_t)(stride*sizeof(long long)));
...
void xbgas_ushort_get(unsigned short *dest, const unsigned short *src,
  ...
  if( nelems >= _XBRTIME_MIN_UNR_THRESHOLD_ ){
    ...
    /* sequential execution */
    __xbrtime_get_u2_seq((uint64_t)(src),
                         (uint64_t)(dest),
                         xbrtime_decode_pe(pe),
                         (uint32_t)(nelems),
                         (uint32_t)(stride*sizeof(unsigned short)));
